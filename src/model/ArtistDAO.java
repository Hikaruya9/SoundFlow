...
public class ArtistDAO {
    ...
    public void add(int id, String name, String about, String genre, String imagePath){
        String sql = "INSERT INTO artist(name,about,genre,image_path) VALUES(?,?,?,?)";
    ...
    public ArrayList<Artist> getByName(String name){
        ...
        String sql = "SELECT id,name,about,genre,image_path FROM artist WHERE name LIKE(?)";
        try(Connection conn = DB.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)){
    ...
    public boolean update(int id, String name, String about, String genre, String imagePath){
